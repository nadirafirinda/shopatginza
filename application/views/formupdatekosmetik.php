            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="adminutama">Dashboard</a>
                            </li>
                            <li class="active">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php echo form_open_multipart(base_url('Welcome/updatekosmetik/' . $kodebarang));  ?>
                        <form role="form">
                            ...
                            <!-- <td><input type="text" name="kode_barang" value="<?php echo $kodebarang;?>"><br/></td> --> 
                            <!-- <div class="form-group">
                                <label>Gambar</label>
