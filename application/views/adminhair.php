                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $x['deskripsi'] ?></td>
                                        <td><?= $x['review'] ?></td>
                                        <td><p><a href="<?php echo base_url().'Welcome/edithair/'.$x['kodebarang'] ?>" input type = "submit" value = "Edit"><span class="label label-warning">Edit</span></p><a href="<?php echo base_url().'Welcome/deletehair/'.$x['kodebarang'] ?>" input type = "submit" value = "Edit"><span class="label label-danger">Delete</span></a></td>
                                    </tr>
                                    <?php } ?>                                    
                                </tbody>
                            </table>
